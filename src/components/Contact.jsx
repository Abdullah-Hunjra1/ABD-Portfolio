...
const socialLinks = [
    {
      href: 'https://www.github.com/Abdullah-Hunjra1',
    ...
    {
      href: 'https://www.linkedin.com/in/abdullah-jutt-8194bb279?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <form action="https://getform.io/f/adrrpqma" method="POST" className=" xl:pl-10 2xl:pl-20">
                <div className=" md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className=" mb-4">
                        ...
                        <input type="email" name="email" id="email" autoComplete="email" required placeholder="jutt@gmail.com" className="text-field reveal-up" />
                    </div>
